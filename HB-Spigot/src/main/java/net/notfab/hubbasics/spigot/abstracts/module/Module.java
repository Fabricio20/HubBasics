package net.notfab.hubbasics.spigot.abstracts.module;
...
public abstract class Module implements Listener {
    ...
    public Module(ModuleEnum moduleEnum) {
        ...
        this.loadKey = ConfigurationKey.getKey(this.getModuleEnum(), ConfigurationKey.ModuleSetting.LOAD);

        ConfigurationKey enabledList = ConfigurationKey.getKey(this.getModuleEnum(), ConfigurationKey.ModuleSetting.ENABLED_WORLD_LIST);
        if (enabledList != null) this.enabledKey = enabledList;
        else this.enabledKey = ConfigurationKey.getKey(this.getModuleEnum(), ConfigurationKey.ModuleSetting.ENABLED_GLOBAL);

        if (this.getEnabledKey() != null) {
            if (this.getEnabledKey().getModuleSetting() == ConfigurationKey.ModuleSetting.ENABLED_WORLD_LIST && this.getLoadKey() == null) {
    ...
    public Boolean isEnabledInWorld(World world) {
        if (this.getEnabledKey().getModuleSetting() != ConfigurationKey.ModuleSetting.ENABLED_WORLD_LIST)
    ...
    public Boolean isEnabled() {
        if (this.getEnabledKey().getModuleSetting() != ConfigurationKey.ModuleSetting.ENABLED_GLOBAL)
