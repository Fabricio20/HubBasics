...
import net.notfab.hubbasics.spigot.commands.HatCommand;
...
import net.notfab.hubbasics.spigot.abstracts.command.HCommand;
import net.notfab.hubbasics.spigot.commands.DelWarpCommand;
import net.notfab.hubbasics.spigot.commands.HBReloadCommand;
import net.notfab.hubbasics.spigot.commands.HologramsCmd;
import net.notfab.hubbasics.spigot.commands.HubCommand;
import net.notfab.hubbasics.spigot.commands.SetHubCommand;
import net.notfab.hubbasics.spigot.commands.SetWarpCommand;
import net.notfab.hubbasics.spigot.commands.WarpsCommand;
