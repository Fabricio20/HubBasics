package net.notfab.hubbasics.spigot.plugin.settings;
...
import net.notfab.hubbasics.spigot.utils.ConfigDefaults;
...
public enum ConfigurationKey {
    ...
    COMMAND_OVERRIDE_COMMANDS("Commands", false, Arrays.asList("{\"command\":\"plugin\",\"aliases\":\"pl\",\"permission\":\"hbspigot.bypass.plugin\",\"message\":\"&cYou don't have permission to execute this command\"}"), ModuleEnum.COMMAND_OVERRIDE),
